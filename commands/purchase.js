...
module.exports.run = async (client, message, args, prefix, player, db) => {
  ...
  if (iteme.civ && stats.coins >= iteme.civ) {
    ...
    message.channel.send(`✅Successfully paid <:valtz:899373217255407646>${iteme.civ} and bought a ${iteme.name}!`);
    return;
    ...
    message.channel.send(`✅Successfully paid <:premiumvaltz:899373241557209158>${iteme.cigv} and bought a ${iteme.name}!`);
    return;

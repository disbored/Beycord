...
module.exports.run = async (client, message, args, prefix, player, db) => {
    ...
    if (args[0] && (args[0].toLowerCase() === "claim" || args[0].toLowerCase() === "complete" || args[0].toLowerCase() === "finish")) {
        ...
        if (quest.completed) {
            message.channel.send(`Quest completed! You received ${quest.rewards}!`)
            questc.award(stats, db, qindex);
        } else {
            message.channel.send("Please complete that quest first.")
        }
        ...
        switch (stats.qslots) {
            case 1:
                ...
                message.channel.send("You unlocked Slot 2!");
                break;
            case 2:
                ...
                message.channel.send("You unlocked Slot 3!");
                break;
            case 3:
                ...
                message.channel.send("You unlocked Slot 4!");
                break;
            case 4:
                ...
                message.channel.send("You unlocked Slot 5!");
                break;
        }
        ...
        message.channel.send(`Successfully removed ${quest.name}!`)
    } else {

...
module.exports.run = async (client, message, args, prefix, player, db) => {
  ...
  if (args[0] && args[0].toLowerCase() == "claim") {
    ...
    return message.channel.send(`You claimed <:valtz:999800344848650410> ${user.balance}. Thanks for being part of 2021's LNY event!`);
  }
  ...
  client.send(message.channel.id, { embed: embed });
}
